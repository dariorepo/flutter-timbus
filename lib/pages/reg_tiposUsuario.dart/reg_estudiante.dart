...
import 'package:proyecto_tim_bus/utils/validador_campos.dart';
 ...
 class reg_estudiante extends StatefulWidget {
    static String etiqueta = 'pagina-acceso';

  @override
  _reg_estudianteState createState() => _reg_estudianteState();
}
class _reg_estudianteState extends State<reg_estudiante>{
