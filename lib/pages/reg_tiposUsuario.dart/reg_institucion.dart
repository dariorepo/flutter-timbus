...
class reg_institucion extends StatefulWidget {
  static String etiqueta = 'pagina-acceso';

  @override
  _reg_institucionState createState() => _reg_institucionState();
}

class _reg_institucionState extends State<reg_institucion> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("registro institucion"),
      ),
      /*
      drawer: Drawer(
        child:ListView(
        ...
        child: ListView(shrinkWrap: true, children: <Widget>[
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                labelText: "Nombre",
                hintText: 'Escriba su nombre de institucion',
              ),
