...
class UsuarioEstudiante extends StatelessWidget {
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    IconButton(
                        onPressed: () => Navigator.of(context)
                        .pushNamed(RutasEnlace.ConfiguracionesEstudinate),
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              */
                              ...
                              //boton de perfil del usuario estudiante
                              ElevatedButton(
                                ...
                                onPressed: () => Navigator.of(context)
                                    .pushNamed(RutasEnlace.PerfilUsuario),
                              ...
                              ElevatedButton(
                                ...
                                //al presionar el boton hace una accion
                                onPressed: () => Navigator.of(context)
                                    .pushNamed(RutasEnlace.RutaUsuario),
                                //Navigator.of(context).pushNamed(AppRoutes.products),
                              ),
                            ],
                          ),
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(//todo=    aqui las dimenciones
                            ...
                            child: ElevatedButton(
                              ...
                              //al presionar el boton hace una accion
                              onPressed: () => Navigator.of(context)
                                  .pushNamed(RutasEnlace.InstitucionUsuario),
                              //Navigator.of(context).pushNamed(AppRoutes.products),
                            ),
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            child: const Text('Pago Transporte',
                                style: TextStyle(
                                    color: Colors.black,
                                    decoration: TextDecoration.none)),
                            //al presionar el boton hace una accion
                            onPressed: () => Navigator.of(context)
                                .pushNamed(RutasEnlace.PaginaPago),
                            //Navigator.of(context).pushNamed(AppRoutes.products),
                          ),
                        ),
                      ],
