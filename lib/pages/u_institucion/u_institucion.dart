...
class UsuarioInstitucion extends StatelessWidget {
            ...
            children: <Widget>[
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    IconButton(
                        onPressed: () => Navigator.of(context)
                        .pushNamed(RutasEnlace.ConfiguracionesInstitucion),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    //todo= container de el encabezado usuario & ruta
                    Container(
                            ...
                            children: <Widget>[
                              ...
                              */
                              ...
                              ElevatedButton(
                                ...
                                onPressed: () => Navigator.of(context)
                                    .pushNamed(RutasEnlace.PerfilInstitucion),
                              ...
                              ElevatedButton(
                                ...
                                //al presionar el boton hace una accion
                                onPressed: () => Navigator.of(context)
                                .pushNamed(RutasEnlace.RutaInstitucion)
                                ,
                                //Navigator.of(context).pushNamed(AppRoutes.products),
                              ),
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              child: const Text('Empresas de Transporte',
                                  style: TextStyle(
                                      color: Colors.black,
                                      decoration: TextDecoration.none)),
                              //al presionar el boton hace una accion
                              onPressed: () => Navigator.of(context)
                              .pushNamed(RutasEnlace.InscripcionTransporte),
                              //Navigator.of(context).pushNamed(AppRoutes.products),
                            ),
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            child: const Text('Inscripcion al Transporte',
                                style: TextStyle(
                                    color: Colors.black,
                                    decoration: TextDecoration.none)),
                            //al presionar el boton hace una accion
                            onPressed: () => Navigator.of(context)
                            .pushNamed(RutasEnlace.FormatoInscripcion)
                            ,
                            //Navigator.of(context).pushNamed(AppRoutes.products),
                          ),
                        ),
